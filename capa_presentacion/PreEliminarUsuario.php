	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form action="../capa_entidad/EntEliminarUsuario.php" method="post" class="needs-validation" novalidate autocomplete="off">
					<?php require "../capa_entidad/EntBuscarEliminarUsuario.php";
					?>					
					<br>	
